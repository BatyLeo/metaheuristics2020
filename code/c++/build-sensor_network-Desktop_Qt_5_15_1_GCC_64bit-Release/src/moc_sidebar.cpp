...
#include <memory>
#include "../../sensor_network/src/interface/sidebar.h"
...
QT_MOC_LITERAL(1, 8, 23), // "selectedSolutionChanged"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 14), // "solution_index"
QT_MOC_LITERAL(4, 48, 24), // "computeHeuristicSolution"
QT_MOC_LITERAL(5, 73, 19) // "launchMetaheuristic"

    },
    "Sidebar\0selectedSolutionChanged\0\0"
    "solution_index\0computeHeuristicSolution\0"
    "launchMetaheuristic"
};
...
void Sidebar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->selectedSolutionChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->computeHeuristicSolution(); break;
        case 2: _t->launchMetaheuristic(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sidebar::selectedSolutionChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sidebar::computeHeuristicSolution)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Sidebar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sidebar::launchMetaheuristic)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Sidebar::selectedSolutionChanged(int _t1)
{
...
// SIGNAL 1
void Sidebar::computeHeuristicSolution()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Sidebar::launchMetaheuristic()
{
