...
QT_MOC_LITERAL(4, 34, 5) // "start"
    ...
    "SolutionView\0rowsInserted\0\0parent\0"
    "start"
};
...
static const uint qt_meta_data_SolutionView[] = {
 ...
 // slots: parameters
    QMetaType::Void, QMetaType::QModelIndex, QMetaType::Int, QMetaType::Int,    3,    4,    2,
...
void SolutionView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SolutionView *_t = static_cast<SolutionView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject SolutionView::staticMetaObject = {
    { &QAbstractItemView::staticMetaObject, qt_meta_stringdata_SolutionView.data,
      qt_meta_data_SolutionView,  qt_static_metacall, nullptr, nullptr}
};
